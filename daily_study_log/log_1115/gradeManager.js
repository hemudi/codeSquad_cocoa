/*
    [문제 1] : 구현중
    [ V ] 평균을 구하는 함수 getMean() 구현
    [ V ] 표준편차를 구하는 함수 getStandardDeviation() 구현
    [ V ] 표준정규분포표를 참고하여 70~80 점 사이의 비율 구하는 기능 구현

    ×ISSUE×
    [   ] 다른 분들이 구한 비율이랑...소숫점 단위에서 차이가 남...45퍼센트는 맞는데....ㅠ
    [   ] [60, 60, 60, ... , 60] 과 같은 테스트케이스에서 오류가 발생 => 예외처리 필요

    [문제 2] : 미구현
    [   ] node.js 비동기 방식으로 사용자 입력을 받음
    [   ] 과목별로 결과가 나오도록 구현
    [   ] 퀵소트를 사용해 과목별 점수를 정렬하는 기능 추가
*/
